<x-layout>
    ...
    <section class="hero-section d-flex align-items-center justify-content-center text-center text-white" role="banner">
        <div class="container">
            <img src="{{ Storage::url('images/logoPrincipale.png') }}" alt="Logo DC Studio Barber" class="img-fluid mb-4"
            ...
            <a href="barberapp://open" class="btn btn-outline-light btn-lg mt-4"
                aria-label="Prenota un appuntamento">Prenota ora</a>
            <p class="mt-3 text-white small">
                Per prenotare, scarica l'app <strong>BarberApp</strong> e inserisci il codice attività
                <strong>558755</strong>.
            </p>
        </div>
    </section>
    ...
    <section class="about-section py-5 text-light" id="chi-siamo" role="region" aria-labelledby="chi-siamo-titolo">
        <div class="container text-center">
            ...
            <p class="lead">DC Studio è molto più di un barbiere. È uno spazio dove stile, precisione e accoglienza si
                fondono per offrirti l'esperienza perfetta. Ogni cliente è unico — proprio come ogni nostro taglio.</p>
        </div>
    </section>
    ...
    <section class="services-section py-5 text-dark" id="servizi" role="region" aria-labelledby="servizi-titolo">
        <div class="container">
            <h2 id="servizi-titolo" class="text-center section-title mb-5 text-uppercase text-light">I nostri servizi
            </h2>
            <div class="row text-center g-4">
                ...
                <div class="col-md-4">
                    <article class="p-4 bg-white rounded shadow-sm h-100 hover-up">
                        ...
                        <p>Taglio + barba + shampoo per un servizio completo a 25€. Anche permanente e meches
                            disponibili!</p>
                    </article>
                </div>
