<nav class="navbar navbar-expand-lg nav-cus fixed-top" role="navigation" aria-label="Barra di navigazione principale"
    data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navMenu"
            aria-controls="navMenu" aria-expanded="false" aria-label="Menu di navigazione">
